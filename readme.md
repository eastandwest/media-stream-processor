...
```
git clone git://anongit.freedesktop.org/git/gstreamer/gstreamer --branch 1.12.0
git clone git://anongit.freedesktop.org/git/gstreamer/gst-plugins-base --branch 1.12.0
git clone git://anongit.freedesktop.org/git/gstreamer/gst-plugins-good --branch 1.12.0
git clone git://anongit.freedesktop.org/git/gstreamer/gst-plugins-ugly --branch 1.12.0
git clone git://anongit.freedesktop.org/git/gstreamer/gst-omx --branch 1.12.0
```
